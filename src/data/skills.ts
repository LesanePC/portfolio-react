...
export const skills: Skill[] = [
    { icon: "fab fa-html5", color: "#e34c26", text: "HTML5 · CSS3 · SCSS · Flexbox · Grid · Адаптивная верстка" },
    { icon: "fab fa-js", color: "#f7df1e", text: "JavaScript (ES6+) · DOM · Fetch API · LocalStorage · Асинхронность" },
    { icon: "fab fa-react", color: "#61dafb", text: "React 19 (Hooks) · TypeScript (в процессе)" },
    { icon: "fab fa-git-alt", color: "#f05032", text: "Git · GitHub · GitHub Pages" },
